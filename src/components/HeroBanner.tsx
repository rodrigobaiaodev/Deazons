  ...
  return (
    <div className="relative w-full h-[65vh] md:h-[85vh] overflow-hidden bg-background">
      ...
      <img
        ...
        fetchPriority="high"
        decoding="async"
        className="absolute inset-0 w-full h-full object-cover object-center md:object-top opacity-60 scale-105 animate-in fade-in duration-1000 zoom-in-105"
      />
