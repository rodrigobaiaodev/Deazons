      ...
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="space-y-4 md:col-span-1">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Descubra milhares de filmes, séries e celebridades do mundo do entretenimento.
            </p>
            {/* Social Icons */}
            <div className="flex items-center gap-3 pt-1">
              <a
                ...
                className="w-8 h-8 rounded-full bg-white/5 hover:bg-primary/20 hover:text-primary transition-all flex items-center justify-center text-muted-foreground"
              >
        ...
        <div className="border-t border-border/20 mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3">
          ...
          <p className="text-xs text-muted-foreground text-center sm:text-right">
            Dados fornecidos pela API do TMDB. Deazons não é endossado pelo TMDB.
          </p>
        </div>
      </div>
    </footer>
